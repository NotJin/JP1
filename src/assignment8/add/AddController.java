...
import assignment8.list.ListController;
...
public class AddController implements Initializable {
    ...
    public void add(ActionEvent actionEvent){
        try {
            ...
            for (Books b: ListController.bookList) {
            ...
            ListController.bookList.add(new Books(id, name, author, publisher, type, price, quantity));
