...
import assignment8.Books;
import assignment8.Main;
import assignment8.edit.EditController;
...
//        bookList.add(new Book("B005", "And There Was Light: Abraham Lincoln and the American Struggle", "Jon Meacham", "Macmillan", "History", 24.58, 165));
    ...
    public void goToEdit(ActionEvent actionEvent){
        try {
            ...
            if (confirmAlert.showAndWait().get() == ButtonType.OK) {
                EditController.editedBook = lvBook.getSelectionModel().getSelectedItem();
    ...
    public void search(ActionEvent actionEvent) {
        ...
        ObservableList<Books> searchResult = FXCollections.observableArrayList();
